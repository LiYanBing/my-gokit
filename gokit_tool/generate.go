...
func GenAPI(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, apiTemplate, data)
}

// endpoints
func GenEndpoints(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, endpointsTemplate, data)
}

// transport
func GenTransport(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, transportTemplate, data)
}

// client
func GenClient(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, clientTemplate, data)
}

// service
func GenService(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, serviceTemplate, data)
}

// server
func GenServer(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, serverTemplate, data)
}

// client
func GenServerClient(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, serverClientTemplate, data)
}

// cmd
func GenCmd(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, cmdTemplate, data)
}

// main.go
func GenMain(filePath string, data *Data) error {
	return genFileWithTemplate(filePath, mainTemplate, data)
}
...
func genFileWithTemplate(filePath, content string, data *Data) error {
	...
	return createFile(filePath, contentBuf.String(), 0666)
}
